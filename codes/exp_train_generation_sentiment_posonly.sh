...
python $code_dir/thumt_gen/bin/trainer.py \
    --input $train_dir/pos_label_train.spm.txt $train_dir/pos_sent_train.spm.txt \
    --validation $train_dir/pos_label_valid.spm.txt $train_dir/pos_sent_valid.spm.txt \
    --reference $train_dir/pos_sent_valid.spm.txt \
    --output train_gen3 \
