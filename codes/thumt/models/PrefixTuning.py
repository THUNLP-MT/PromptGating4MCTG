...
class GatingModule(nn.Module):
    def __init__(self, prompt_num: int, embed_dim: int, dropout, hidden_dim: int = 512, pri_dim: int = 512, seg_num: int = 2, layer_num: int = 12) -> None:
        ...
        self.new_gating = nn.ModuleList([nn.Sequential(
            ...
            # nn.Linear(self.mid_dim, self.mid_dim),
            # nn.Tanh(),
            nn.Linear(hidden_dim, embed_dim*layer_num),
    ...
    def forward(self, attach=None):
        ...
        #     if i == 0:
        #         continue
        #     idx2name = {1: 'mask', 2: 'tense', 3: 'fr'}
        #     OUTPUT_PT = "/home/lzj/lzj/plug4MSG/pluginMSG/analyse_gate_tr/b"
        ...
        #         continue
        #     idx2name = {1: 'mask', 2: 'tense', 3: 'fr'}
        #     OUTPUT_PT = "/home/lzj/lzj/plug4MSG/pluginMSG/analyse_gate_tr/"
        #     output_i = OUTPUT_PT + idx2name[i]
        #     for j in range(self.layer_num):
        #         output_j = output_i + str(j) + '.pt'
